    ...
    return(
        <div className="info__container">
            ...
            <div className="info__bottom-row">
                ...
                <img src={storefront} alt="storefront" className="info__storefront-image"/>
            </div>
        </div>
    )
}
